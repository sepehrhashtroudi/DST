...
lstm_out = Bidirectional(LSTM(units=150, return_sequences=False , stateful = False))(embeding_out)
# lstm_out = TimeDistributed(Dense(76, activation='relu'))(lstm_out)
...
bs_out_food_joined = Dropout(0.01)(bs_out_food_joined)
...
bs_out_price_joined = concatenate([lstm_out, bs_input_price])
